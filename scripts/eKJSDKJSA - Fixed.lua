...
-- ✅ TELEPORT ROBUSTO OPTIMIZADO (Solución anti Rubberbanding)
local function smoothTeleport(targetPos)
    ...
    -- CAPEO FÍSICO SEGURO: Si moveSpeed es muy alto, lo dividimos en ticks menores
    -- para evitar el anti-cheat de Roblox que causa Rubberband.
    ...
    while traveled < totalDist do
        ...
        local move = math.min(safeStep, totalDist - traveled)
