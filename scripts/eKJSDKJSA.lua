...
-- ✅ SISTEMA ANTI-AFK (Input real simulado + compatibilidad multi-executor)
local function runAntiAfk()
    while antiAfkEnabled do
        task.wait(600 + math.random(-20, 20)) -- ~10 min con variación anti-detección
        pcall(function()
            -- 🥇 Prioridad 1: Funciones nativas del executor (más seguras)
            ...
            elseif mouse1click then
                ...
                -- 🥈 Fallback universal: VirtualInputManager (funciona en Synapse, Fluxus, Codex, etc.)
